...
public class FlowerCrownModel extends GeoModel<FlowerCrownItem> {
    private final ResourceLocation FLOWER_CROWN_MODEL = ResourceLocation.fromNamespaceAndPath(CreaturesAndBeastsCommon.MOD_ID, "geo/armor/flower_crown.geo.json");
    private final ResourceLocation FLOWER_CROWN_TEXTURE = ResourceLocation.fromNamespaceAndPath(CreaturesAndBeastsCommon.MOD_ID, "textures/armor/flower_crown.png");
    private final ResourceLocation FLOWER_CROWN_ANIMATION = ResourceLocation.fromNamespaceAndPath(CreaturesAndBeastsCommon.MOD_ID, "animations/flower_crown.json");
